...
import edu.utoronto.group0162.core.entity.PackageInfo;
 ...
 * @since 0.2
 */
@ComponentScan(basePackageClasses = edu.utoronto.group0162.core.service.PackageInfo.class)
@Configuration
@EnableJpaRepositories(basePackageClasses = edu.utoronto.group0162.core.dao.PackageInfo.class)
...
public class ApplicationContext {
  ...
  public Properties hibernateProperties() {
    ...
    hibernateProperties.put(AUTO_COMMIT, this.autocommit);
